...
Die folgenden Aktualisierungen wurden an der Dokumentation zu Customer Journey Analytics seit ihrer Einführung vorgenommen.
...
| --- | --- |
| **Juni 2023** | |
| Kanalübergreifende Analyse und Stitching | Um die bevorstehenden Änderungen vorwegzunehmen, die das Stitching ermöglichen, und um weiter zu klären, wie die kanalübergreifende Analyse mithilfe des Stitching erhöht werden kann, wird die Dokumentation zur kanalübergreifenden Analyse bearbeitet, siehe [Cross-Channel-Analyse](../use-cases/cross-channel/cross-channel.md) als Customer Journey Analytics-Funktion und Anwendungsfall und [Stitching](../stitching/overview.md) als eine wichtige Funktion, um dies zu erreichen. |
...
| Updates zu berechneten Metriken | Die folgende Dokumentation zu berechneten Metriken wurde aktualisiert, um sie an die aktuelle Customer Journey Analytics-Funktion anzupassen: <ul><li>Die Liste der [Berechnete Standardmetriken](/help/components/calc-metrics/default-calcmetrics.md) verfügbar in Customer Journey Analytics</li><li>Aktualisierte Screenshots und Verfahren in verschiedenen Artikeln zu berechneten Metriken </li></ul> |
| **Mai 2023** | |
...
| Update zur Optimierung | Aktualisierter Artikel zu [Optimieren der Leistung von Customer Journey Analytics](/help/admin/optimizing-performance.md) |
...
| Abgeleitete Felder | Die Dokumentation wurde hinzugefügt für [abgeleitete Felder](../data-views/derived-fields/derived-fields.md) Funktionalität. |
| **April 2023** |  |
...
| **März 2023** | |
| Integrieren von Entscheidungs-Management-Daten | Es wurden Inhalte hinzugefügt, die erklären, wie [Adobe Journey Optimizer-Entscheidungsverwaltungsdaten in Customer Journey Analytics integrieren](/help/integrations/ajo-od.md). |
...
| Aktualisierte Funktionsunterstützung | Aktualisiert [Unterstützung von Customer Journey Analytics-Funktionen](/help/getting-started/aa-vs-cja/cja-aa.md) mit einer Tabelle von Funktionen, die in Customer Journey Analytics verfügbar, aber in AA nicht verfügbar oder unterstützt sind. |
...
| Mobile Scorecards | Neuer Dokumentationsabschnitt, um zu beschreiben, wie Sie Vergleichsdatumsbereiche ein- und ausblenden. Siehe [Vergleichsdatumsbereiche anzeigen](/help/mobile-app/create-scorecard.md#show-comparison-dates) in Customer Journey Analytics. |
| **Januar 2023** | |
...
| Schnellstartanleitungen zur Datenaufnahme | Neuer Dokumentationsabschnitt zum Thema [Daten erfassen und verwenden](/help/data-ingestion/data-ingestion.md) in Customer Journey Analytics. |
...
| --- | --- |
| **Dezember 2022** |  |
| 16. Dezember 2022 | Neues Thema zu [Messen und Verwalten der Nutzung von Customer Journey Analytics-Daten](/help/admin/estimate-usage.md). |
| **Oktober 2022** | |
...
| **September 2022** | |
| September 2022 | Neuer Anwendungsfall: [Migrieren von Google Analytics-Daten zu Customer Journey Analytics](/help/use-cases/ga/overview.md). |
...
| August 2022 | Signifikant aktualisierter Artikel zu [Zugriffskontrolle auf Customer Journey Analytics](/help/admin/cja-access-control.md). |
...
| Juni 2022 | Neuer Artikel zu [Vergleich der Datenverarbeitung über Adobe Analytics- und Customer Journey Analytics-Berichterstellungsfunktionen hinweg](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| **Mai 2022** | |
| Mai 2022 | Signifikant aktualisierter Artikel zu [Erstellen von Verbindungen](/help/connections/create-connection.md) in Customer Journey Analytics. |
| Mai 2022 | Neuer Artikel zum Thema [Datenblöcke in Customer Journey Analytics Report Builder verwalten](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=de). |
| Mai 2022 | Neuer Artikel zu [Erfassen von Adobe Experience Platform-Zielgruppen in Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **April 2022** | |
...
| April 2022 | Neu [Benutzerhandbuch für Customer Journey Analytics für Adobe Analytics-Benutzer](/help/getting-started/aa-to-cja-user.md). |
| **März 2022** | |
| März 2022 | Neu [Dokumentation zur Customer Journey Analytics Annotations-API](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **Februar 2022** | |
| Februar 2022 | Ein neues Handbuch für Administratoren, die von Adobe Analytics zu Customer Journey Analytics wechseln: [Entwicklung von Adobe Analytics zu Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=de) |
| **Januar 2022** | |
| Januar 2022 | Neues Anwendungsbeispiel für [Bindungsdimensionen und Metriken in Customer Journey Analytics verwenden](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| Januar 2022 | Neuer Artikel zu [Vergleichen Ihrer Adobe Analytics-Daten mit Analytics-Daten in Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=de) |
...
| September 2021 | Neuer Abschnitt zu [Auswirkungen der Zusammenführung von Report Suites](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=de#6-considerations-when-merging-report-suites-in-cja) in Customer Journey Analytics. |
| **August 2021** | |
| August 2021 | Neuer Abschnitt zur erweiterten [Verbindungen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=de) Erfahrung in Customer Journey Analytics. |
...
| April 2021 | Neues Thema zu [Dimensionen mit hoher Kardinalität im Customer Journey Analytics](/help/components/dimensions/high-cardinality.md). |
| **März 2021** | |
...
| Februar 2021 | Die neue [Customer Journey Analytics-API](https://www.adobe.io/cja-apis/docs/) Dokumentation. |
| **Januar 2021** | |
...
| Dezember 2019 | Erster Entwurf der Dokumentation zum Customer Journey Analytics |
