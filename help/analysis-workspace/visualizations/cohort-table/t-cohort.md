...
1. (Optional) Erstellen Sie einen Filter aus einer Auswahl.
   ...
   Wählen Sie Zellen aus (zusammenhängend oder nicht zusammenhängend) und klicken Sie dann mit der rechten Maustaste auf > **[!UICONTROL Filter aus Auswahl erstellen]**.

1. Bearbeiten Sie den Filter im [Filtergenerator](/help/components/filters/manage-filters.md) weiter und klicken Sie dann auf **[!UICONTROL Speichern]**.

   Der gespeicherte Filter ist für die Verwendung im Bedienfeld [!UICONTROL Filter] in [!UICONTROL Analysis Workspace] verfügbar.
