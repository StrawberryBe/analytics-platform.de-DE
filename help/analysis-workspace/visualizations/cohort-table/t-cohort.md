...
1. (Optional) Erstellen Sie einen Filter aus einer Auswahl.
   ...
   Wählen Sie Zellen (zusammenhängend oder nicht zusammenhängend) und klicken Sie dann mit der rechten Maustaste auf > **[!UICONTROL Filter aus Auswahl erstellen]**.

1. Bearbeiten Sie den Filter in [Filteraufbau](/help/components/filters/manage-filters.md) weiter und klicken Sie dann auf **[!UICONTROL Speichern]**.

   Der gespeicherte Filter steht im Bedienfeld [!UICONTROL Filter] unter [!UICONTROL Analysis Workspace] zur Verfügung.
