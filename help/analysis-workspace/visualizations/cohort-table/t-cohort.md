...
1. (Optional) Erstellen Sie einen Filter aus einer Auswahl.
   ...
   Wählen Sie Zellen aus (zusammenhängend oder nicht zusammenhängend) und klicken Sie mit der rechten Maustaste auf > **[!UICONTROL Filter aus Auswahl erstellen]**.

1. Im [Filter Builder](/help/components/filters/manage-filters.md), bearbeiten Sie den Filter weiter und klicken Sie dann auf **[!UICONTROL Speichern]**.

   Der gespeicherte Filter kann im [!UICONTROL Filter] Bedienfeld in [!UICONTROL Analysis Workspace].
