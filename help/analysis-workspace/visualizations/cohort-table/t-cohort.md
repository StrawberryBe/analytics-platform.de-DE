...
1. Im [Filter Builder](https://docs.adobe.com/content/help/de-DE/analytics/components/segmentation/segmentation-workflow/seg-build.html), bearbeiten Sie das Segment weiter und klicken Sie dann auf **[!UICONTROL Speichern]**.
