...
Wenn Sie Ihrer Tabelle lieber zuerst mehrere Komponenten hinzufügen und dann die Daten rendern möchten, können Sie Freiformtabellen-Builder aktivieren. Wenn der Builder aktiviert ist, können Sie Tabellen mit vielen Dimensionen, Unterteilungen, Metriken und Filtern per Drag &amp; Drop erstellen, um komplexere Fragen zu beantworten. Daten werden nicht sofort aktualisiert. Sie werden erst aktualisiert, wenn Sie auf **[!UICONTROL Erstellen]** klicken.
...
* **Spalten**
   * Komponenten können innerhalb von Spalten gestapelt werden, um gefilterte Metriken, tabulatorübergreifende Analysen und mehr zu erstellen.
