...
Einige dieser Voreinstellungen können auch für einzelne Projekte angepasst werden, wie unter [Projektübersicht](/help/analysis-workspace/build-workspace-project/freeform-overview.md) beschrieben.
...
|  | Gesamtsummen anzeigen | Dieser Gesamtwert stellt alle erfassten Treffer dar, manchmal auch als &quot;Datenansichtssumme&quot;bezeichnet. Wenn ein Filter entweder auf Bedienfeldebene oder in der Freiformtabelle angewendet wird, passt sich diese Summe an, sodass alle Treffer wiedergegeben werden, die den Filterkriterien entsprechen. Gesamtsumme wird für Tabellen oder Aufschlüsselungen mit [statischen Zeilen](/help/analysis-workspace/visualizations/freeform-table/workspace-totals.md) nicht unterstützt. |
...
1. Wählen Sie in Customer Journey Analytics [!UICONTROL **Komponenten**] **>** [!UICONTROL **Voreinstellungen**].
