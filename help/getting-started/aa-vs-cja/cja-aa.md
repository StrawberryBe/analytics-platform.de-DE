...
| Streamen von Media Analytics | Mediendaten sind über Analytics Data Connector als Teil des Bedienfelds &quot;Gleichzeitige Medienbetrachter&quot;und des Bedienfelds &quot;Besuchszeit für Medienwiedergabe&quot;in Workspace verfügbar. |
...
| Funktion | Hinweise |
| --- | --- |
| Zielgruppenveröffentlichung (Segmentveröffentlichung) | Wird unterstützt, wenn eine Lizenz für die Kundendatenplattform von Adobe oder Journey Optimizer-Produkte erteilt wurde. [Zielgruppenveröffentlichung](/help/components/audiences/audiences-overview.md) sendet Zielgruppen in Experience Platform an das Echtzeit-Kundenprofil. |
...
| Deduplizierung der Metrik | Jetzt für Metriken in Datenansichten konfiguriert. Die Metrikdeduplizierung erfolgt auf der Personen- oder Sitzungsebene und nicht auf der Ebene des Datensatzes, der Datenansicht oder der Verbindung. |
...
| Reporting über neue und wiederholte Sitzungen | Zuvor mit der Dimension Besuchsnummer erreicht. Neue und wiederholte Sitzungen werden unterstützt [mit einem 13-monatigen Lookback-Fenster](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=de#new-repeat). |
...
| Benutzerberechtigungen/Datenzugriffssteuerung | CJA unterscheidet zwischen [Adobe Admin Console](https://experienceleague.adobe.com/docs/core-services/interface/administration/admin-getting-started.html?lang=de) Produktadministratoren, Produktprofiladministratoren und Benutzer. Nur Produktadministratoren können von anderen Benutzern erstellte Verbindungen, Projekte, Filter oder berechnete Metriken erstellen/aktualisieren/löschen, während Produktadministratoren und Produktprofiladministratoren Datenansichten bearbeiten können. Zusätzliche Benutzerberechtigungen sind für Dinge wie das Erstellen berechneter Metriken, Filter oder Anmerkungen verfügbar. |
...
| Funktion | Hinweise |
| --- | --- |
| Marketing-Kanäle | Daten von Marketing-Kanälen werden über den Analytics-Quell-Connector an CJA weitergeleitet. Marketing-Kanalregeln müssen weiterhin im herkömmlichen Adobe Analytics konfiguriert werden und einige Regeln werden nicht unterstützt. Weitere Informationen finden Sie in der [Customer Journey Analytics Marketing-Kanal-Dokumentation](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/marketing-channels.html?lang=de#cja-usecases). Darüber hinaus stehen für WebSDK-Implementierungen Plug-ins zur Client-seitigen Definition von Marketing-Kanälen zur Verfügung. Die künftige Unterstützung für Verarbeitungsregeln für Marketing-Kanäle in Berichtszeiten ist geplant. |
| Geräteübergreifende/kanalübergreifende Zuordnung | Unterstützt für Datensätze, die direkt Identitätsinformationen enthalten (auch &quot;feldbasiertes&quot;Stitching); Graph-basiertes Stitching wird noch nicht unterstützt, aber geplant. Siehe [Cross-Channel-Analysen](/help/connections/cca/overview.md). |
...
| A4T | Teilweise wird die Unterstützung über Felder im [Analytics Source Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html). Unterstützung für A4T-Anzeigenamen für Target-Aktivitäten und -Erlebnisse ist geplant. |
...
| Transaktions-ID-Data Sources | Unterstützung ist geplant. |
