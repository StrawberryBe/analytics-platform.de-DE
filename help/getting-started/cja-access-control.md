...
| **[!UICONTROL Zugriff auf Auditprotokolle]** | Zurzeit sind [Audit-Protokolle](https://adobe.io/cja-apis/docs/endpoints/auditlogs/) nur über die API verfügbar. Diese Berechtigung erzwingt die Berechtigungsprüfung für die API und eine neue Benutzeroberfläche für Audit-Protokolle. |
