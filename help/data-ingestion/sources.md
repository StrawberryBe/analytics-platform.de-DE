---
title: Daten über Quell-Connectoren erfassen und verwenden
...
In dieser Kurzanleitung wird erläutert, wie Sie Daten mithilfe eines Quell-Connectors zu einem Datenanbieter in Adobe Experience Platform erfassen und diese Daten dann in Customer Journey Analytics verwenden können.
...
## Quell-Connector verwenden

Je nachdem, woher Sie die Treuedaten erhalten, wählen Sie den entsprechenden Quell-Connector aus, der in Adobe Experience Platform verfügbar ist.

So richten Sie einen Quell-Connector ein:

1. Wählen Sie in der Adobe Experience Platform-Benutzeroberfläche **[!UICONTROL Quellen]** von [!UICONTROL VERBINDUNGEN] in der linken Leiste.

2. Wählen Sie Ihren Quell-Connector aus der Liste der verfügbaren Quell-Connectoren aus. Jeder Connector folgt einem ähnlichen Workflow:

   - **[!UICONTROL Authentifizierung]**. Sie geben Authentifizierungsdetails an, um auf die Datenquelle zuzugreifen.
   ...
   So greifen Sie auf diese Dokumentation zu:

   - Wählen Sie auf der Connector-Kachel die **[!UICONTROL ...]** neben [!UICONTROL Einrichten] oder [!UICONTROL Daten hinzufügen].

      ![Dokumentation anzeigen](./assets/sourceconnector-documentation.png)

   - Auswählen **[!UICONTROL Dokumentation anzeigen]**.


Siehe [Daten aus dem herkömmlichen Adobe Analytics erfassen und verwenden](./analytics.md) Verwendung des Adobe Analytics-Quell-Connectors.

Siehe [Streaming-Daten erfassen und verwenden](./streaming.md) Verwendung des Quell-Connectors für die HTTP-API.

Siehe [Übersicht über Quell-Connectoren](https://experienceleague.adobe.com/docs/experience-platform/sources/home.html?lang=en#terms-and-conditions) für einen Überblick über Quell-Connectoren, einschließlich Links zu weiteren Informationen zu den einzelnen Connectoren.
