...
Sie verwenden die Workflow-Funktion, um Ihre Batch-Daten in Adobe Experience Platform hochzuladen. Die Beispiel-Batch-Datei, die wir verwenden, ist eine CSV-Datei mit folgendem Inhalt:
...
3. Im [!UICONTROL Zuordnen von CSV zu XDM-Schema] im [!UICONTROL Datenflussdetails] step:
   ...
   Auswählen **[!UICONTROL Vorhandener Datensatz]**, wählen Sie Ihre aus der Datensatzliste aus und benennen Sie Ihre [!UICONTROL Dataflow-Name].
...
5. Im [!UICONTROL Zuordnung] step:
   ...
   Ordnen Sie Ihre Daten aus der CSV-Datei den Daten in Ihrem Schema zu. Mithilfe von AI versucht die Workflow-Funktion, die Batch-Datenfelder automatisch den Schemafeldern zuzuordnen.
...
6. Auswählen **[!UICONTROL Beenden]** , um Ihre Batch-Daten in Adobe Experience Platform aufzunehmen.

Siehe [CSV-Datei über einem vorhandenen XDM-Schema zuordnen](https://experienceleague.adobe.com/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema.html) für weitere Informationen zur Zuordnung von Daten, wenn Ihre eingehenden Daten nicht mit Ihrem XDM-Schema kompatibel sind, verwenden Sie Zuordnungsvorlagen, verwenden Sie berechnetes Feld, um sicherzustellen, dass Ihre Batch-Daten dem entsprechen, was das Schema erwartet, usw.
