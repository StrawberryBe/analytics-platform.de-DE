...
Gibt den Namen der Container für die Datenansicht an. Container-Namen werden häufig in [Filter](/help/components/filters/filters-overview.md#Filter-containers).
