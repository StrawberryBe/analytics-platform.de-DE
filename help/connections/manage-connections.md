...
| [!UICONTROL Hinzugefügte Datensätze] | Zeigt, wie viele Zeilen im ausgewählten Zeitraum hinzugefügt wurden. <p>**Hinweis**: Daten für **[!UICONTROL hinzugefügte Datensätze]** umfassen derzeit nur Ereignisdaten, keine Profil- oder Suchdaten. |
| [!UICONTROL Gelöschte Datensätze] | Zeit die Anzahl der im ausgewählten Zeitraum gelöschten Datensätze. <p>**Hinweis**: Daten für **[!UICONTROL gelöschte Datensätze]** umfassen derzeit nur Ereignisdaten, keine Profil- oder Suchdaten. |
