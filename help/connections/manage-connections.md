...
| [!UICONTROL Hinzugefügte Datensätze] | Zeigt, wie viele Zeilen im ausgewählten Zeitraum hinzugefügt wurden. |
| [!UICONTROL Gelöschte Datensätze] | Zeit die Anzahl der im ausgewählten Zeitraum gelöschten Datensätze. |
