...
Nachdem Sie eine Zielgruppe erstellt haben, erstellt Adobe für jede neue CJA-Zielgruppe ein Experience Platformen-Streaming-Segment. Ein AEP-Streaming-Segment wird nur erstellt, wenn die Organisation für Streaming-Segmentierung eingerichtet ist.
