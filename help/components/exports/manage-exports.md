...
Nachdem Sie eine vollständige Tabelle wie unter [Customer Journey Analytics-Daten in die Cloud exportieren](/help/analysis-workspace/export/export-cloud.md), sind die Exporte im Abschnitt [!UICONTROL Exporte] auf der Registerkarte [!UICONTROL Exporte] Seite.
...
1. Wählen Sie die **Tabelle anpassen** icon ![Anpassbare Tabelle](assets/customize-table-icon.png) oben rechts im [!UICONTROL Exporte] Seite.
   ...
   |---------|----------|
   | Name | Der Name des Exports. Benutzer geben Exporten einen Namen, wenn sie sie erstellen, wie in [Customer Journey Analytics-Daten in die Cloud exportieren](/help/analysis-workspace/export/export-cloud.md). |
